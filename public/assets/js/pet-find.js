$(document).ready(function() {
  ...
  $("#submitDogSearch").on("click",  function(event) {
    ...
    $.ajax({
      url: "https://cors-anywhere.herokuapp.com/http://api.petfinder.com/pet.find?key=" + devkey + "&animal=dog&location=" + zip + "&breed=" + breed + "&sex=" + gender + "&size=" + size + "&age=" + age + "&format=json",
      method: "GET",
      success: function(data, status) {
        ...
        for (var i = 0; i < 8; i++) {
          ...
          var dogInfo = 
            `<div class="card border-info" style="max-width:25rem;">
              ...
              <div class="card-body text-info">
                ...
                <h5 class="dog-age">${dogs.pet[i].sex.$t}</h5>
